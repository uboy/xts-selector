...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--count", type=int, default=None, help="Target number of PRs after filtering"
    )
    parser.add_argument(
        "--max-pages",
        type=int,
...
def main() -> None:
    ...
    print(
        f"Fetching PRs from {args.owner}/{args.repo} (state={args.state}, target={args.count})..."
    )
    prs = fetch_prs(
        args.owner,
        args.repo,
