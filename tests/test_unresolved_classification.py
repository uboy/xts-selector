...
class ClassifyUnresolvedTests(unittest.TestCase):
    ...
    def _make_signals(
        self, member_hints=None, type_hints=None, symbols=None, project_hints=None
    ):
        return {
    ...
    def test_no_consumer_member_evidence(self) -> None:
        ...
        result = _classify_unresolved(
            changed_file=Path(
                "foundation/arkui/ace_engine/frameworks/core/interfaces/native/node/button_modifier.cpp"
            ),
    ...
    def test_unsupported_generated_pattern(self) -> None:
        ...
        result = _classify_unresolved(
            changed_file=Path(
                "foundation/arkui/ace_engine/advanced_ui_component_static/assembled_advanced_ui_component/ButtonWrapper.ets"
            ),
            signals=self._make_signals(),
            api_lineage_map=None,
            consumer_semantics=[],
    ...
    def test_lineage_gap_with_member_hints_but_no_consumer(self) -> None:
        ...
        result = _classify_unresolved(
            changed_file=Path(
                "foundation/arkui/ace_engine/frameworks/core/components_ng/pattern/menu/menu_item_pattern.cpp"
            ),
