...
class TestParentOverride:
    def test_text_scrolltovisible(self):
        assert get_parent_override("text", "scrollToVisible") == "RichEditorBaseController"
...
class TestBlacklist:
    ...
    def test_custom_config(self, tmp_path: Path):
        ...
        config = {"method_to_member": {}, "family_member_to_parent": {},
        ...
        mod._CONFIG_PATH = Path(__file__).resolve().parents[2] / "config" / "sdk_member_aliases.json"
        mod.load_aliases.cache_clear()
