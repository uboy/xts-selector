...
def _execute_plan_item(
    ...
    deadline = None if timeout_value is None else (started_monotonic + float(timeout_value))
...
def execute_planned_targets(
    ...
    summary["has_failures"] = bool(
        summary["failed"] or summary["blocked"] or summary["timeout"] or summary["unavailable"]
    )
